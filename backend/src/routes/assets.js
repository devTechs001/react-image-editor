...
router.route('/')
  ...
  .post(uploadAny.array('files', 10), handleUploadError, assetController.uploadAssets);

router.route('/:id')
  .get(ownsResource('Asset'), assetController.getAsset)
  .put(ownsResource('Asset'), assetController.updateAsset)
  .delete(ownsResource('Asset'), assetController.deleteAsset);
