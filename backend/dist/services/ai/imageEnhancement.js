  ...
  try {
    ...
    switch (type) {
      case 'general':
        ...
        output = await replicate.run('nightmareai/real-esrgan:42fed1c4974146d4d2414e2be2c5277c7fcf05fcc3a73abf41610695738c1d7b', {
          input: {
            image: dataUri,
            scale: 1,
            face_enhance: true
      ...
      case 'low-light':
        ...
        output = await replicate.run('cjwbw/llve:c2efd0ce18db3ed4af5b18d4e5a18b8d3f5e7c94', {
          input: {
            image: dataUri
          }
        });
      ...
      case 'deblur':
        ...
        output = await replicate.run('megvii-research/nafnet:9a7f5d09e34a9f3dc14c6f5c7b8e9d0c1f2a3b4c', {
          input: {
            image: dataUri,
            task: 'Deblur'
          }
