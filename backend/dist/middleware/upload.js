...
const uploadVideo = multer({
  storage,
  limits: {
    fileSize: config.upload.maxFileSize * 10,
    // 500MB for videos
    files: 5
  },
...
const uploadAny = multer({
  ...
  fileFilter: fileFilter([...config.upload.allowedImageTypes, ...config.upload.allowedVideoTypes, ...config.upload.allowedAudioTypes])
});
